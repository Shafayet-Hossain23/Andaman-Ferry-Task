...
import RouteMiddleChild from './RouteMiddleChild';
        ...
        <div>
            <div className='bg-white py-4 px-2'>
                <div className='text-center my-3'>
                    <h1 className='font-medium'>PORTBLAIR → HAVELOCK</h1>
                    <p className='text-xs'>15-Apr-2023</p>
                </div>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                <div className='bg-[#FFF2EB] text-[#F7772D] text-sm p-3 text-center'>
                    <p>👉 You need to arrive at Jetty at-least 60 mins prior to the scheduled departure.</p>
                </div>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                <div className='bg-[#FFF2EB] text-[#F7772D] text-sm p-3 text-center'>
                    <p>👉 It takes about 20-30 mins to reach Port Blair Jetty from the airport.</p>
                </div>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                <RouteMiddleChild></RouteMiddleChild>
                ...
                {/* <div className='border p-3 rounded-md hover:bg-[#F9F9F9]'>
                    <div className='flex justify-between'>
                        ...
                        <div>
                            ...
                            <button onClick={() => setOpen(true)} className={`mt-5 border  py-[6px] px-4 bg-[#01B46C] font-semibold text-white rounded-sm transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 hover:shadow-md ${open ? 'hidden' : 'block'}`}>Select Ferry</button>
                        </div>
